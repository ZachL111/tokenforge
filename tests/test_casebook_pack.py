"""Regression checks for the tokenforge casebook."""
...
from casebook.harness import assert_expected, tokenforge_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(tokenforge_summary(), assert_expected())
